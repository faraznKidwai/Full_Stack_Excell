...
const UserView = () => {
  ...
  return (
    <div className="user-page" style={{ backgroundColor: '#f8fafc', minHeight: '100vh', fontFamily: 'sans-serif' }}>
      {/* ===== TOP BAR ===== */}
      <div className="topbar" id="topbar">
        <div className="topbar__inner">
          ...
          <div className="topbar__right">
            <a href="https://wa.me/918694010200" target="_blank" rel="noopener noreferrer" className="topbar__link">
      ...
      <nav className="main-nav" id="main-nav">
        <div className="main-nav__inner">
          <a href="https://zamzam-capital.com/" target="_blank" className="main-nav__logo-link">
            <span className="main-nav__brand"><img src={logo} alt="Zamzam Capital" /></span>
          </a>
          <div className="main-nav__links">
            <a href="/" className="main-nav__link main-nav__link--active">Screener</a>
            <a href="https://zamzam-capital.com/halal-stocks/" target="_blank" rel="noopener noreferrer" className="main-nav__link">
              Halal Stocks
            </a>
          </div>
        </div>
      ...
      <div style={{ padding: '40px 20px', maxWidth: '1200px', margin: '40px auto 20px auto' }}>
        <div style={{
          ...
          <p style={{
            ...
            before their Offer Date on an on-going basis through its{' '}
            <a 
              href="https://t.me/zamzamcapital" 
              target="_blank" 
              rel="noopener noreferrer" 
              style={{ color: '#22d3ee', textDecoration: 'underline', fontWeight: '500' }}
            >
              Telegram Channel
            </a>
          </p>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{ textTransform: 'uppercase', fontSize: '0.7rem', letterSpacing: '1.5px', color: '#64748b', fontWeight: '700', margin: '0 0 8px 0' }}>
                Total Stocks Covered
              </p>
              <h3 style={{ fontSize: '1.75rem', fontWeight: '800', color: '#0f172a', margin: '0 0 8px 0' }}>
                {stats.totalStocks ? stats.totalStocks.toLocaleString() : '1,694'}
              </h3>
              <p style={{ fontSize: '0.8rem', color: '#64748b', margin: '0', lineHeight: '1.5' }}>
                Only NSE-listed stocks with Market Cap &gt; INR 500 Cr are included in our screening universe.
              </p>
            </div>
      ...
      <div style={{ padding: '0 20px', maxWidth: '1200px', margin: '0 auto 40px auto' }}>
        <div style={{
          backgroundColor: '#ffffff',
          borderRadius: '16px',
          border: '1px solid #e2e8f0',
          ...
          <div style={{
            ...
            <div style={{ padding: '32px' }}>
              <h4 style={{
                ...
                Halal List Comprised of Shariah-Compliant Shares listed in the Indian Stock Market
              </h4>
              ...
              <p style={{
                ...
                Listed companies on the National Stock Exchange (NSE) with a market capitalisation of at least INR 500 crore have been certified as <strong style={{ color: '#0f172a' }}>Shariah Compliant</strong> by the Shariah Board of Zamzam Capital, comprised of the following Shariah Scholars:
              </p>
              ...
              <p style={{
                ...
                Shariah-compliance screening covers business activity, 
                financial ratios analysis and qualitative research parameters. 
                The criteria used by the Shariah Board of Zamzam Capital is published <a href="https://zamzam-capital.com/shariah/" target = "blank" style={{ color: '#02966c', textDecoration: 'underline' }}>here</a>. 
                This Screener will use data from the latest Halal Stocks List issued by the Shariah Board of Zamzam Capital that is 
                published <a href="https://zamzam-capital.com/halal-stocks/" target = "blank" style={{ color: '#02966c', textDecoration: 'underline' }}>here</a>.
              </p>
            </div>
          </div>
      ...
      <section className="search-section" id="search-section">
        ...
        <div className="search-section__meta">
          Showing {Math.min(visibleCount, filteredCompanies.length)} of {filteredCompanies.length} stocks
        </div>
      </section>
